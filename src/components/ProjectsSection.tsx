          ...
          {filtered.slice(0, 3).map((p) => (
            ...
            >
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <div className="mb-4">
                  <span className="inline-block rounded-full bg-gold/5 px-2 py-0.5 text-[9px] font-bold text-gold uppercase tracking-widest border border-gold/20">
                    {p.tenure || "Freehold"}
                  </span>
                </div>
                  ...
                  {p.market_value && (
                    <div className="flex justify-between items-center py-0.5 border-b border-border/5">
                      ...
                      <span className="font-bold text-foreground">
                        {convertPrice(p.market_value)} <span className="text-gold text-[9px] ml-1">({p.profit_pct || "100%"})</span>
                      </span>
                    </div>
                  )}
                  {p.exit_projection && (
                    <div className="flex justify-between items-center py-0.5 border-b border-border/5">
                      ...
                      <span className="font-bold text-gold">
                        {convertPrice(p.exit_projection)} <span className="text-[9px] ml-1 opacity-70">({p.exit_pct})</span>
                      </span>
                    </div>
                  )}
