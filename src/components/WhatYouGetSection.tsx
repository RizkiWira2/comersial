...
export default function WhatYouGetSection() {
  ...
  return (
    <section id="what-you-get" className="py-20 bg-background overflow-hidden">
          ...
          {categories.map((cat, ci) => (
            ...
            >
              ...
              <a
                ...
                className="mt-4 inline-flex items-center justify-center w-full rounded-md bg-gold/10 border border-gold/20 px-4 py-2.5 text-xs font-semibold text-gold transition-colors hover:bg-gold hover:text-foreground active:scale-95"
              >
                {t("wyg.contact")}
              </a>
            </motion.div>
