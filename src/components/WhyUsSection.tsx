...
export default function WhyUsSection() {
  ...
  const comparisons = [
    { feature: t("why.comp.h1"), desc: t("why.comp.d1"), us: true, them: false },
    { feature: t("why.comp.h2"), desc: t("why.comp.d2"), us: true, them: false },
    { feature: t("why.comp.h3"), desc: t("why.comp.d3"), us: true, them: false },
    { feature: t("why.comp.h4"), desc: t("why.comp.d4"), us: true, them: false },
    { feature: t("why.comp.h5"), desc: t("why.comp.d5"), us: true, them: false },
  ];

  return (
    <section id="why-us" className="py-20 bg-background overflow-hidden">
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid md:grid-cols-[1fr_320px] gap-12 items-start">
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8 }}
            className="hidden md:block sticky top-24 space-y-4"
          >
